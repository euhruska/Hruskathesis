...
\label{ch:chapter3}
\GRE{In this chapter, we review some of the theory of Adaptive sampling and different Markov processes, transfer operators and their dominant spectrum.The results stated here were originally presented in Ref. X[Noe:2013ab] including the figures in this chapter.}
